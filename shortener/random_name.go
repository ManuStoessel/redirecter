...
// this code was taken from the wonderful Moby project.
// The name generator that was introuced by Docker and sparked much joy for me.
// See here for the origin: https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
